...
def prediction_result():
    ...
    filename = os.path.join(current_directory, 'modelRN.pkl')
    loaded_model= joblib.load(filename)
    #create new dataframe
    df_input = pd.DataFrame(columns = ['pm_sepuluh', 'sulfur_dioksida', 'karbon_monoksida', 'ozon', 'nitrogen_dioksida'])
    df_input.loc[0] = [pm_sepuluh, sulfur_dioksida, karbon_monoksida, ozon, nitrogen_dioksida]
    # print(df_input)
    ...
    return render_template('result.html', pm_sepuluh=pm_sepuluh, sulfur_dioksida=sulfur_dioksida, 
